...
if __name__ == "__main__":
    state = dp_const.states["Penn"]
    graph = Graph.from_json(dp_const.PA_VTD)
    num_districts = dp_const.pa_num_dp
    ...
    plan_output_path = '/gpfs/scratch/joifan/pa_plans_2000/'
    dis_geo_output_path = '/gpfs/scratch/joifan/pa_geo_2000/'
